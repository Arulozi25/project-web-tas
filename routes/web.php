...
// Route::livewire('/admin/crud', 'crud')->name('crud');
Route::livewire('/admin/konfirmasi', 'konfirmasi')->name('konfirmasi')->layout('layouts.admin');
Route::group(['middleware' => ['auth', 'isAdmin']], function () {
    Route::get('/admin', function () {
        return view('admin.Dashboard');
    });
    Route::livewire('/admin/crud', 'crud')->name('crud')->layout('layouts.admin');
});
